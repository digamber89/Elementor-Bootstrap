...
define( 'ELEMENTOR_TEST_FILE', __FILE__ );
define( 'ELEMENTOR_TEST_DIR', dirname( __FILE__ ) );
define( 'ELEMENTOR_TEST_ASSETS_URL', plugins_url( '/assets/', __FILE__ ) );
...
final class Elementor_Test_Extension {
	...
	/*
	 * Register your styles and scripts
	 */
